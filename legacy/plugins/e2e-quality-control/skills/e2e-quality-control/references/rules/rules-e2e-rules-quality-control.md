---
description: Rule-authoring form for E2E rules files
globs:
  - "**/rules/rules-*.md"
alwaysApply: false
---

# Rule: E2E Rules-File Authoring Quality Control
...
- Does not apply to finished artifacts, generator-source content coverage (see
  `rules-e2e-generator-quality-control.md`), workflow documents, or
  orchestrator documents — those have their own authoring-form checks.
