...
- Does not apply to generator sources that produce these artifacts (see
  `rules-e2e-generator-quality-control.md`), to a rules file's own authoring
  form (see `rules-e2e-rules-quality-control.md`), or to workflow or
