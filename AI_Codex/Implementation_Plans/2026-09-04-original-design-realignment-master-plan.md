...
This governing plan follows the [architecture ruling](../../.superpowers/sdd/refactor-align-the-architecture-with-original-design/architecture-ruling.md); the paused 4.0.0 plan is evidence, not build authority.
...
Supersede the paused [4.0.0 plan](2026-09-02-return-to-intention-4-0-0.md); identify salvageable utilities and quarantine absent-engine claims. Freeze prose unless it supports the vertical slice.

Exit evidence: a decision record and ledger checkpoint name the superseded plan, salvage list, quarantined claims, and next executable slice.
...
Exit evidence: generated-config contract tests, one real spawn smoke per available host, verified mailbox, and enforcement/fallback matrix grounded in [Claude agent docs](https://github.com/anthropics/claude-code/blob/main/plugins/plugin-dev/skills/agent-development/SKILL.md), [Cursor subagents docs](https://cursor.com/docs/subagents), and [OpenAI GPT-5.4 Mini docs](https://developers.openai.com/api/docs/models/gpt-5.4-mini).
...
- Binding ruling: [[../../.superpowers/sdd/refactor-align-the-architecture-with-original-design/architecture-ruling]]
...
- Discovery: [ancestors](../../.superpowers/sdd/refactor-align-the-architecture-with-original-design/discovery-ancestors.md) · [host surfaces](../../.superpowers/sdd/refactor-align-the-architecture-with-original-design/discovery-host-surfaces.md)
